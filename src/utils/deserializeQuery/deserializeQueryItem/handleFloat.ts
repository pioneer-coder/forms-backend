...
function handleFloat(item: QueryStringItem): number | undefined
function handleFloat(item: QueryStringItem, opts: Options & { defaultValue?: never }): number | undefined;
function handleFloat(item: QueryStringItem, opts: Options & { defaultValue: number }): number;
function handleFloat(item: QueryStringItem, opts?: Options): number | undefined {
